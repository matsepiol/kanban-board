...
System.register("api", [], function($__export) {
  "use strict";
  ...
  $__export("getTasks", getTasks);
  $__export("getTaskById", getTaskById);
  $__export("addTask", addTask);
  $__export("editTask", editTask);
  $__export("deleteTask", deleteTask);
  return {
    setters: [],
    execute: function() {
      baseDomain = 'http://localhost:3000/', http = new XMLHttpRequest();
...
System.register("main", ["api"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      ...
      window.toggleDialog = (function(taskObj) {
        ...
        if (taskObj) {
          var $__0 = taskObj,
              taskName = $__0.taskName,
              taskAuthor = $__0.taskAuthor,
              taskDesc = $__0.taskDesc,
              taskType = $__0.taskType;
      ...
      $__export("Api", Api), $__export("fetchTask", fetchTask), $__export("addTask", addTask), $__export("toggleDialog", toggleDialog), $__export("editTask", editTask);
    }
  };
});
